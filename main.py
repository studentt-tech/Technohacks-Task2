...
Label(root,text="Length of Password",fg="RoyalBlue1",bg="white",font=("Helvetica",16)).place(x=435,y=60)
Entry(root,textvariable=pwd_len,width=15,font=("Helvetica",18)).place(x=435,y=100)
Button(root,text="Generate Password",command=get_pass,bg="RoyalBlue1",fg="white",font=("Helvetica",14)).place(x=440,y=160)
Entry(root,textvariable=passstr,width=15,font=("Helvetica",18)).place(x=435,y=230)
Button(root,text="Re-Generate Password",command=get_pass,bg="RoyalBlue1",fg="white",font=("Helvetica",14)).place(x=430,y=300)
